...
'(((KEY 1) (PHON THE) (MORPH D)
  ...
  ((KEY 5) (PHON CORNER) (MORPH N) (SYN ((BCAT N) (FEATS NIL))) (SEM "CORNER")
   (PARAM 1.0))
  ...
  ((INDEX #:_TRC376) (KEY 12) (PARAM 1.0) (INSEM LF)
  ...
  ((INDEX #:_TRC378) (KEY 14) (PARAM 1.0) (INSEM LF)
   ...
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
     ...
     ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
      (DIR FS) (MODAL ALL) ((BCAT VP) (FEATS NIL))))))
  ((INDEX #:_MLU385) (KEY 21) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    (((BCAT S) (FEATS NIL)) (DIR FS) (MODAL ALL)
     (((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL))))))
  ((INDEX #:_MLU387) (KEY 23) (PARAM 1.0) (INSEM LF)
   (OUTSEM (LAM LF (LAM P (P LF)))) (INSYN ((BCAT NP) (FEATS NIL)))
   (OUTSYN
    ((((BCAT S) (FEATS NIL)) (DIR BS) (MODAL ALL) ((BCAT NP) (FEATS NIL)))
     (DIR BS) (MODAL ALL)
